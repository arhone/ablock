...
$(function() {
    ...
    let aBlock = {
        ...
        init: function (host) {
            ...
            if (typeof modules[host] !== 'undefined') {
                modules[host]();
            } else {
                modules.other()
            }
        ...
        okAdBlock: function () {
            ...
            $('.feed-list .feed-w [data-seen-params]').each(function (key, value) {
               let data = $(value).data('seen-params');
               if (
                   data && typeof data['options'] !== 'undefined'
                   && typeof data['options']['onScrollSeen'] !== 'undefined'
                   && data['options']['onScrollSeen'] === false
                   && $(value).find('.feed_top span:contains(Р)')
                   && $(value).find('.feed_top span:contains(м)')
                   && $(value).find('.feed_top span:contains(а)')
               ) {
                   $(value).remove();
               }
            });
